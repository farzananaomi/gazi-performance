            ...
            <div class="box box-primary">
                ...
                <div class=table-responsive><table class="table">
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($subgroup->cash*100/$totalSalesCash, 2) }} %</td>
                        <td>{{ $subgroup->amount }}</td>
                        <td>{{ number_format($subgroup->amount*100/$totalSalesQuantity, 2) }} %</td>
                    </tr>
                    </tbody>
                </table></div>
                <!-- /.box-body -->
                    ...
                    <div class=table-responsive><table class="table table-hover no-wrap" id="products-table" style="width: 100%;">
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>{{ $subgroup->amount == 0? '--':number_format($product->amount*100/$subgroup->amount, 2) }}</td>
            ...
            var groupData = {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        data: [{!! $subgroup->amount !!}, {!! $totalSalesQuantity - $subgroup->amount !!}],
                        backgroundColor: [
                            "#e67e22",
                            "#95a5a6"
                        ],
