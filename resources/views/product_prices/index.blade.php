...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Product Prices List</li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-md-4 col-xs-12">
            <div class="box box-solid bg-green-gradient">
                ...
                <div class="box-footer text-black">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="{{ route('products.prices.show') }}" method="get" id="chart-picker-form">
                                <input type="hidden" id="month-selection" name="month">
                                <input type="hidden" id="year-selection" name="year">
                                <button type="submit" id="chart-picker-submit" class="btn btn-default btn-block"><i class="fa fa-search"></i> Show</button>
                                <button type="submit" id="product-prices-create" class="btn btn-default col-md-6 col-xs-12"><i class="fa fa-plus"></i> Create</button>
                            </form>
                        </div>
                    </div>
                    <!-- /.row -->
        ...
        <div class="col-md-6 col-xs-12">
            <div class="box box-default">
                <div class="box-header">
                    <div class="box-title">Listed Price Charts</div>
                </div>
                <div class=table-responsive><table class="table table-bordered">
                    <thead>
                    <tr>
                        <th>Price chart for Month/Year</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($charts as $chart)
                        <tr>
                            <td style="font-size: 18px;">
                                <a href="{{ route('products.prices.show', ['month' => $chart->month, 'year' => $chart->year]) }}"
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#chart-picker-form').on('submit', function () {
                updateDateFieldValues();
            });

            $("#chart-picker-submit").click(function() {
                $(this).closest("form").attr("action", "{{ route('products.prices.show') }}");
            });
            $("#product-prices-create").click(function() {
                $(this).closest("form").attr("action", "{{ route('products.prices.create', '') }}");
            });
